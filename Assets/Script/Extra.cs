...
public class Extra : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        master.Difficulty = Master.Mode.extra;
        
        LeftController = Hard;
        LeftIcon = IconOfHard;
        chara = CharacterKind.hard_Asuka;
        chara = CharacterKind.hard_Asuka;
        master.state = GameState.Extra;
    }

    void Start()
    {
        parent = GameObject.Find("Extra");
    ...
    void Update()
    {
...

        {
                ...
                else if (Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.K))
                {
                    if (isClick)
                    {
                        isClick = false;
    ...
    { 
        ...
        critical = selectList[count].critical /100;
